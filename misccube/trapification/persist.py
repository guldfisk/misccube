...
class DistributionModel(Serializeable):
    
    def __init__(self, traps: t.Tuple[t.Tuple[ConstrainedNode, ...], ...]):
        self._traps = traps

    @property
    def traps(self) -> t.Tuple[t.Tuple[ConstrainedNode, ...], ...]:
        return self._traps
    ...
    @classmethod
    def deserialize(cls, value: serialization_model, inflator: Inflator) -> DistributionModel:
        return cls(
            tuple(
                tuple(
